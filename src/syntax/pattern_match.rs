    ...
    pub fn from_pattern_as_cells(list: CellRef) -> Result<PatternMatch, BindError> {
        ...
        while let SafasCell::List(car, cdr) = list_pos {
            ...
            match &**car {
                ...
                SafasCell::Monad(_) | SafasCell::MacroMonad(_) | SafasCell::ActionMonad(_) | SafasCell::FrameReference(_, _) | SafasCell::MacroReference(_) => { return Err(BindError::NotValidInSyntax) }
            }
